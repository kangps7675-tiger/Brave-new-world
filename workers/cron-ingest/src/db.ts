...
export async function pruneOldRows(db: D1Database, retentionHours: number) {
  ...
  // ?”ë ˆê·¸ëž¨?€ ?€ë¹ˆë„ ì±„ë„???ˆì–´ ë³´ì¡´ì°½ì„ 2ë°°ë¡œ (ìµœì†Œ 24h)
  ...
  // ?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€
  // ?„ëž˜ ì§‘ê³„Â·?´ë²¤???Œì´ë¸”ì? **?í’ˆ ?ì‚°**?´ë‹¤ (?ìžë£??„ë‹˜).
  //
  // ?ìžë£?FIRMS/GDELT/AIS/ADS-B/?´ìŠ¤)??ë¬´ê²ê³??¬ì·¨??ê°€?¥í•˜ë¯€ë¡?ê³„ì† prune ?œë‹¤.
  // ë°˜ë©´ ?¼ë³„ ì§‘ê³„?€ ?´ë²¤??ë¡œê·¸??
  //   - ?‰ì´ ê·¹ížˆ ?‘ë‹¤ (?„ìž¥ 20ê°?Ã— 365??= ??7,300??
...
/**
 * ê²½ëŸ‰ UI ?´ë²¤??ë¡œê·¸ ?ìž¬ ??Vercel(D1 ë°”ì¸???†ìŒ)?ì„œ /track ê²½ìœ ë¡??„ë‹¬ë°›ì•„ ?¬ê¸°???€.
