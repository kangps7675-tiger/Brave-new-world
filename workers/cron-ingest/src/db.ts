...
/**
 * ì´ë²ˆ ë°°ì¹˜ì— í¬í•¨ëœ MMSIë“¤ì˜ "ì§ì „" ìœ„ì¹˜ë¥¼ D1ì—ì„œ ì½ì–´ì˜¨ë‹¤ â€” upsertë¡œ ë®ì–´ì“°ê¸° ì „ì—
 * ë°˜ë“œì‹œ ë¨¼ì € í˜¸ì¶œí•´ì•¼ í•œë‹¤ (ì•„ë‹ˆë©´ ì´ì „ ìœ„ì¹˜ë¥¼ ì˜ì˜ ìƒëŠ”ë‹¤).
 * ais_vesselsëŠ” MMSIë‹¹ 1í–‰ë§Œ ìœ ì§€í•˜ë¯€ë¡œ ì´ê²Œ ìœ ì¼í•œ "ì´ì „ ìƒíƒœ" ì†ŒìŠ¤ë‹¤.
 */
...
/**
 * ìµœê·¼ Nì‹œê°„ ê²Œì´íŠ¸ë³„ ë°©í–¥ë³„ í†µê³¼ ì²™ìˆ˜ â€” "ë°©í–¥ë³„ ê²Œì´íŠ¸ í†µê³¼ ì„ ë°• ìˆ˜" ì§€í‘œì˜
 * ê°€ì¥ ê¸°ë³¸ í˜•íƒœë‹¤. category(ë¯¼ê°„/êµ°ìš©)ê¹Œì§€ ìª½ê°œì„œ ë°˜í™˜í•œë‹¤.
 * DWT ê°€ì¤‘ì¹˜Â·ì†ë„ ê¸‰ê°Â·í‰ì‹œ ëŒ€ë¹„ z-score ê°™ì€ ê³ ê¸‰ ì§€í‘œëŠ” ì•„ì§ ì—†ë‹¤ â€”
 * ì € ê°’ë“¤ì„ ì‹ ë¢°ì„± ìˆê²Œ ë‚´ë ¤ë ¤ë©´ ìˆ˜ ì£¼ì¹˜ ëˆ„ì  ë°ì´í„°ë¡œ "í‰ì‹œ" ê¸°ì¤€ì„ ì„ ë¨¼ì €
 * ë§Œë“¤ì–´ì•¼ í•˜ëŠ”ë°, ì´ í…Œì´ë¸”ì´ ì´ì œ ë§‰ ìƒê²¨ì„œ ê¸°ì¤€ì„ ì´ ì—†ë‹¤.
 */
