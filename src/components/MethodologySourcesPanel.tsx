...
export function MethodologySourcesPanel({
  ...
  return (
    <>
      ...
      />
      <aside
        className="intel-panel absolute right-3 top-14 z-[120] flex max-h-[calc(100vh-4.5rem)] w-[min(calc(100vw-1.5rem),400px)] flex-col overflow-hidden rounded-2xl shadow-2xl"
        role="dialog"
