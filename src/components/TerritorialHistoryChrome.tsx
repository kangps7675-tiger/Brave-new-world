...
export function TerritorialHistoryChrome({
  ...
  return (
    <aside
      ...
      className="pointer-events-auto absolute bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] left-3 z-[120] flex max-h-[min(52vh,420px)] w-[min(94vw,340px)] flex-col overflow-hidden rounded-2xl border border-rose-300/25 bg-[#160d10]/94 shadow-2xl backdrop-blur-xl"
    >
      <div className="flex items-start justify-between gap-2 border-b border-rose-200/10 px-3 py-2.5">
        <div className="min-w-0">
          <p className="text-[10px] uppercase tracking-[0.2em] text-rose-200/55">
          ...
          <p className="mt-1 text-[10px] leading-4 text-rose-100/50">
            {ko
        ...
        <button
          ...
          className="tap-target shrink-0 rounded-lg border border-rose-300/25 px-2 py-1 text-[10px] text-rose-100/70 transition hover:border-rose-200/40 hover:text-rose-50"
        >
      ...
      <div className="flex gap-1.5 border-b border-rose-200/10 px-3 py-2">
        {onBackToList ? (
          <button
            ...
            className="tap-target min-h-[44px] shrink-0 rounded-lg border border-rose-300/25 px-2 text-[11px] text-rose-100/75 transition hover:border-rose-200/40 hover:text-rose-50"
          >
            {ko ? "목록" : "List"}
          </button>
        ) : null}
            ...
            <li key={stage.id}>
              ...
              >
                <div className="flex items-baseline justify-between gap-2">
                  <span className="text-[10px] font-semibold text-rose-200/70">
                ...
                {revealed ? (
                  <p className="mt-0.5 line-clamp-2 text-[10px] leading-4 text-rose-100/55">
