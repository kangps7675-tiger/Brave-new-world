...
export function MapAttributionBar({
  ...
  return (
    <div
      className={`map-attribution-bar pointer-events-auto absolute bottom-2 left-2 z-30 flex max-w-[94vw] items-center gap-1.5 overflow-hidden rounded-md border border-white/10 bg-[#04070f]/75 px-2 py-1 text-[10px] leading-none text-slate-400 backdrop-blur-sm ${className}`}
    >
      {/* 베이스맵 — 라이선스상 상시 노출 */}
