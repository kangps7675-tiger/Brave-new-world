  ...
  return (
    <button
      ...
      className={
        active
          ? economyMode
            ? "pointer-events-auto rounded-sm border border-amber-400/50 bg-amber-950/80 px-2.5 py-1.5 text-micro font-bold uppercase tracking-[0.14em] text-amber-100 shadow-lg"
            : "pointer-events-auto rounded-sm border border-rose-400/50 bg-rose-950/80 px-2.5 py-1.5 text-micro font-bold uppercase tracking-[0.14em] text-rose-100 shadow-lg"
          : "pointer-events-auto rounded-sm border border-slate-500/40 bg-slate-950/75 px-2.5 py-1.5 text-micro font-bold uppercase tracking-[0.14em] text-slate-300 shadow-sm transition hover:border-rose-400/40 hover:text-rose-100"
      }
    >
    ...
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[900] flex justify-center px-3 pt-3 sm:pt-4">
      ...
      >
        <div className="min-w-0 flex-1">
          <p
            className={`text-micro font-bold uppercase tracking-[0.2em] ${
