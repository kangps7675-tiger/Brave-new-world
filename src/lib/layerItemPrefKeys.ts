...
export const LAYER_ITEM_PREF_KEYS: Partial<Record<string, keyof LayerPrefs>> = {
  ...
  "conflict-events": "showConflictEvents",
  "conflict-theater-ukraine": "showConflictTheaterUkraine",
  "conflict-theater-iran": "showConflictTheaterIran",
  "conflict-theater-lebanon": "showConflictTheaterLebanon",
  "conflict-theater-syria": "showConflictTheaterSyria",
  "conflict-theater-taiwan": "showConflictTheaterTaiwan",
  "conflict-theater-korea": "showConflictTheaterKorea",
  "conflict-theater-south-china-sea": "showConflictTheaterSouthChinaSea",
  "conflict-theater-kuril": "showConflictTheaterKuril",
  "conflict-theater-baltic": "showConflictTheaterBaltic",
  "conflict-theater-black-sea": "showConflictTheaterBlackSea",
  "conflict-theater-japan": "showConflictTheaterJapan",
  "conflict-theater-caucasus": "showConflictTheaterCaucasus",
  "conflict-theater-central-asia": "showConflictTheaterCentralAsia",
  ...
  "gta-interventions": "showGtaInterventions",
  ...
  "military-bases-taiwan": "showTaiwanMilitaryBases",
  "military-bases-philippines": "showPhilippinesMilitaryBases",
  "military-bases-australia": "showAustraliaMilitaryBases",
  ...
  "crink-pipeline": "showCrinkInfraPipeline",
  "crink-power-line": "showCrinkInfraPowerLine",
};
