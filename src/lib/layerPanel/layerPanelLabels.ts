...
export const LAYER_ITEM_LABELS: Record<string, { ko: string; en: string }> = {
  ...
  "ukraine-strikes-russia": {
    ko: "우크라→러시아 타격 보도",
    en: "Ukraine strikes on Russia (reported)",
  },
  "conflict-events": { ko: "전장 이벤트", en: "Battlefield events" },
  "conflict-theater-ukraine": { ko: "우크라이나", en: "Ukraine" },
  "conflict-theater-iran": { ko: "이란", en: "Iran" },
  "conflict-theater-lebanon": { ko: "레바논", en: "Lebanon" },
  "conflict-theater-syria": { ko: "시리아", en: "Syria" },
  "conflict-theater-taiwan": { ko: "대만", en: "Taiwan" },
  "conflict-theater-korea": { ko: "한국", en: "Korea" },
  "conflict-theater-south-china-sea": { ko: "남중국해", en: "South China Sea" },
  "conflict-theater-kuril": { ko: "쿠릴", en: "Kurils" },
  "conflict-theater-baltic": { ko: "발트", en: "Baltic" },
  "conflict-theater-black-sea": { ko: "흑해", en: "Black Sea" },
  "conflict-theater-japan": { ko: "일본", en: "Japan" },
  "conflict-theater-caucasus": { ko: "캅카스", en: "Caucasus" },
  "conflict-theater-central-asia": { ko: "중앙아시아", en: "Central Asia" },
  "europe-drone-incidents": {
    ko: "유럽 드론·영공 침범",
    en: "European drone & airspace incursions",
  },
  "weekly-ship-moves": {
    ko: "주간 함선 동향",
    en: "Weekly ship movements",
  },
  "reef-watch": {
    ko: "남중국해 인공섬·암초",
    en: "South China Sea reefs & islands",
  },
  "nk-missile-tests": { ko: "북한 미사일·무기 시험", en: "North Korea missile & weapons tests" },
  "war-zones": { ko: "전쟁·교전 구역", en: "Active war zones" },
  "lsib-boundary": { ko: "국제 국경선", en: "International boundaries" },
  "diplomatic-tension": { ko: "외교 긴장 구역", en: "Diplomatic tension zones" },
  "east-asia-adiz": { ko: "방공식별구역", en: "Air defense zones" },
  ...
  "ukmto-incidents": { ko: "상선 피습·나포 경보", en: "Merchant vessel attack alerts" },
  "escalation-signals": { ko: "주목할 보도", en: "Notable news alerts" },
  "navarea-warnings": { ko: "해상 항행경보", en: "Maritime navigation warnings" },
  ...
  "crink-osm-infra": {
    ko: "CRINK 인프라",
    en: "CRINK infrastructure",
  },
  "conflict-zones": { ko: "추정 분쟁 지역 (데모)", en: "Estimated conflict zones (demo)" },
  "arms-embargo": { ko: "무기 금수 국가", en: "Arms embargo states" },
  ucdp: { ko: "분쟁·전쟁 기록", en: "Conflict & war records" },
  ...
  "lng-terminals": { ko: "액화가스(LNG) 터미널", en: "LNG terminals" },
  ...
  "logistics-risk": { ko: "해상 요충지·협로", en: "Maritime chokepoints & hubs" },
  "logistics-stress": { ko: "혼잡·위험 해협 표시", en: "Color risky & congested straits" },
  "gscpi-gauge": { ko: "공급망 압력", en: "Supply-chain pressure" },
  "critical-nodes": { ko: "핵심 인프라 노드", en: "Critical infrastructure nodes" },
  ais: { ko: "위장·그림자 함대", en: "Spoofed & shadow fleet" },
  "disguised-vessels": { ko: "위장·그림자 함대", en: "Spoofed & shadow fleet" },
  "military-bases": { ko: "군사기지", en: "Military bases" },
  "military-bases-us": { ko: "미군", en: "US forces" },
  "military-bases-rok": { ko: "한국", en: "South Korea" },
  "military-bases-japan": { ko: "일본", en: "Japan" },
  "military-bases-philippines": { ko: "필리핀", en: "Philippines" },
  "military-bases-eastern-nato": { ko: "동유럽 NATO 기지", en: "Eastern NATO bases" },
  "strategic-missile": {
    ko: "미사일 기지·시험장",
    en: "Missile bases & test sites",
  },
  "missile-silos": { ko: "중국 미사일 사일로", en: "Chinese missile silos" },
  ...
  "missile-silo-fields": {
    ko: "중국 사일로 후보 조사지",
    en: "Chinese silo survey grids",
  },
  "military-air": { ko: "군사 항공기", en: "Military aircraft" },
  intel: { ko: "정보·감시 거점", en: "Intel & surveillance sites" },
  refugee: { ko: "난민 캠프", en: "Refugee camps" },
  firms: { ko: "위성 화재 감지", en: "Satellite fire detection" },
  cyber: { ko: "사이버 공격", en: "Cyber attacks" },
  election: { ko: "선거 사건", en: "Election events" },
  space: { ko: "우주 발사", en: "Space launches" },
  "recon-satellites": { ko: "정찰위성", en: "Reconnaissance satellites" },
  "gps-interference": { ko: "GPS 재밍", en: "GPS jamming" },
...
const DETAIL_KO_TO_EN: Array<[RegExp, string]> = [
  ...
  [/전선 OSM/g, "front-line OSM"],
  [/1선 기지/g, "front-line bases"],
  [/폴란드·발트·핀란드/g, "Poland · Baltics · Finland"],
