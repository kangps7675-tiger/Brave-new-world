...
export const STRATEGIC_CORRIDORS: StrategicCorridor[] = [
  ...
  },
  {
    ...
    legs: [
      ...
      },
      {
        ...
        waypoints: [
          { lat: 27.187, lng: 56.278, name: "Bandar Abbas (Persian Gulf port)" },
          { lat: 25.0, lng: 57.5, name: "Gulf of Oman" },
          { lat: 20.0, lng: 65.0, name: "Arabian Sea" },
          { lat: 19.076, lng: 72.877, name: "Mumbai, India" },
        ],
      },
    ],
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 22.0, lng: 120.5, name: "Taiwan Strait approach" },
      ...
      { lat: 29.93, lng: 32.55, name: "Suez (canal south)" },
      { lat: 31.26, lng: 32.3, name: "Port Said (canal north)" },
      { lat: 35.0, lng: 18.0, name: "Central Mediterranean" },
      { lat: 36.14, lng: -5.35, name: "Strait of Gibraltar" },
      { lat: 45.0, lng: -8.0, name: "Bay of Biscay approach" },
      { lat: 50.0, lng: -2.0, name: "English Channel west" },
  ...
  {
    id: "brest-malaszewicze-gauge-terminal",
    nameKo: "브레스트–마와셰비체 궤간변경 터미널",
    nameEn: "Brest–Małaszewicze gauge-break terminal",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong", "OpenStreetMap"],
    note: "1520mm→1435mm 환적 — China–Europe EU 진입 핵심 게이트웨이. Eurostat PL→BY ton-km 센서.",
    waypoints: [
      { lat: 52.097, lng: 23.734, name: "Brest (1520 mm)" },
      { lat: 52.05, lng: 23.52, name: "Małaszewicze (1435 mm)" },
    ],
  },
  {
    id: "lithuania-belarus-rail-gateway",
    nameKo: "리투아니아–벨라루스 철도 게이트웨이",
    nameEn: "Lithuania–Belarus rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    note: "Kena/Mockava 인근 — PL–BY 우회·발트 대안 축.",
    waypoints: [
      { lat: 54.64, lng: 25.55, name: "Kena / Mockava area" },
      { lat: 54.58, lng: 25.85, name: "Belarus border" },
    ],
  },
  {
    id: "latvia-russia-rail-gateway",
    nameKo: "라트비아–러시아 철도 게이트웨이",
    nameEn: "Latvia–Russia rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    waypoints: [
      { lat: 56.386, lng: 28.122, name: "Zilupe" },
      { lat: 56.35, lng: 28.35, name: "Russia border" },
    ],
  },
  {
    id: "estonia-russia-rail-gateway",
    nameKo: "에스토니아–러시아 철도 게이트웨이",
    nameEn: "Estonia–Russia rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    waypoints: [
      { lat: 59.379, lng: 28.179, name: "Narva" },
      { lat: 59.377, lng: 28.22, name: "Ivangorod" },
    ],
  },
  {
    id: "finland-russia-rail-gateway",
    nameKo: "핀란드–러시아 철도 게이트웨이",
    nameEn: "Finland–Russia rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    waypoints: [
      { lat: 60.7, lng: 27.85, name: "Vainikkala" },
      { lat: 60.71, lng: 28.75, name: "Vyborg" },
    ],
  },
  {
    id: "poland-ukraine-rail-gateway",
    nameKo: "폴란드–우크라이나 철도 게이트웨이",
    nameEn: "Poland–Ukraine rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    note: "Medyka / Przemyśl — 곡물·군수·인도적 회랑.",
    waypoints: [
      { lat: 49.807, lng: 22.932, name: "Medyka / Przemyśl" },
      { lat: 49.79, lng: 23.05, name: "Mostyska" },
    ],
  },
  {
    id: "hungary-ukraine-rail-gateway",
    nameKo: "헝가리–우크라이나 철도 게이트웨이 (Záhony)",
    nameEn: "Hungary–Ukraine rail gateway (Záhony)",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    note: "Záhony 궤간변경 터미널.",
    waypoints: [
      { lat: 48.405, lng: 22.176, name: "Záhony" },
      { lat: 48.42, lng: 22.25, name: "Chop" },
    ],
  },
  {
    id: "slovakia-ukraine-rail-gateway",
    nameKo: "슬로바키아–우크라이나 철도 게이트웨이",
    nameEn: "Slovakia–Ukraine rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    waypoints: [
      { lat: 48.39, lng: 22.09, name: "Čierna nad Tisou" },
      { lat: 48.42, lng: 22.2, name: "Chop area" },
    ],
  },
  {
    id: "romania-ukraine-rail-gateway",
    nameKo: "루마니아–우크라이나 철도 게이트웨이",
    nameEn: "Romania–Ukraine rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    waypoints: [
      { lat: 47.95, lng: 26.0, name: "Vadul Siret / Vicșani" },
      { lat: 48.05, lng: 26.15, name: "Ukraine border" },
    ],
  },
  {
    id: "greece-turkey-rail-gateway",
    nameKo: "그리스–튀르키예 철도 게이트웨이",
    nameEn: "Greece–Türkiye rail gateway",
    mode: "rail",
    category: "trade",
    status: "operational",
    sources: ["Eurostat rail_go_intgong"],
    note: "Middle Corridor / INSTC EU 남부 진입 센서.",
    waypoints: [
      { lat: 40.85, lng: 25.87, name: "Alexandroupoli" },
      { lat: 41.01, lng: 26.55, name: "Pythio / border" },
      { lat: 41.01, lng: 28.97, name: "Istanbul" },
    ],
  },
  {
    id: "cpc-pipeline",
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 39.5, lng: 26.0, name: "Dardanelles exit / Aegean" },
      { lat: 35.5, lng: 28.0, name: "Eastern Mediterranean (south of Rhodes)" },
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 29.93, lng: 32.55, name: "Suez (canal south)" },
      { lat: 31.26, lng: 32.3, name: "Port Said (canal north)" },
      { lat: 34.0, lng: 33.0, name: "Eastern Mediterranean" },
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 30.0, lng: 145.0, name: "Western Pacific (east of Japan)" },
      { lat: 33.5, lng: 128.5, name: "Korea Strait approach" },
