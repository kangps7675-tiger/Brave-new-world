...
export const NEWS_LAYER_SOURCE_CATALOG: NewsLayerSourceNote[] = [
  ...
  },
  {
    ...
    notes:
      "Nav 「위성」 basemap — MapLibre-compatible OSM vector style (not satellite raster).",
    status: "shipped",
    ingest: "mapped-existing",
  },
  {
    ...
    notes: "MapLibre setTerrain DEM for intel/photo exaggeration.",
    status: "shipped",
    ingest: "mapped-existing",
  },
  {
    ...
    notes: "3D building fill-extrusion in vector 「위성」 mode at zoom ≥ 14.",
    status: "shipped",
    ingest: "mapped-existing",
  },
  {
