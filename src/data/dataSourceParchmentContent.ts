...
const SECTIONS_KO: DataSourceSection[] = [
  {
    ...
    entries: [
      ...
      {
        name: "AIS 끄거나 위장한 배",
        body: "신호를 끄거나 이름을 바꿔 다니는 배로 알려진 사례를 공개 OSINT와 맞춰 봅니다. 실시간 GPS 위치가 아니라 「알려진 패턴」에 가깝습니다.",
      },
      {
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        body: "뉴스 데이터베이스를 미리 잡아 둔 장소와 맞춰 점을 찍습니다. 탄이 떨어진 좌표가 아니라, 보도가 말한 발생 위치나 보도 위치입니다.",
      },
      {
        name: "대만해협 타임라인",
      ...
      {
        name: "러 전사자·부상 추정",
        body: "언론이 공개한 실명 명단과 추정치입니다. 재배포·화면 이용에는 언론 저작권 조건이 따릅니다.",
      },
      {
        name: "핵탄두 보유량",
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "무역·해운·철도 통계",
        body: "회랑이 얼마나 중요한지 점수를 매길 때 UN·유럽·해운 공개표를 섞습니다.",
      },
      {
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "확전 신호(자체)",
        body: "공개 문헌을 참고해 만든 「분위기가 고조되는지」 보조 지표입니다. 확전을 단정하는 것이 아닙니다.",
      },
      {
        name: "긴장지수(GTS)",
        body: "유명한 테러 지수와는 다른, 이 서비스만의 0~100 점수입니다. 전장 신호와 최근 90일 기준선을 비교해 만듭니다. 칩을 누르면 더 쉽게 풀어 설명합니다.",
      },
    ],
  },
  {
    ...
    entries: [
      ...
      {
        name: "유튜브·텔레그램",
        body: "공식 영상 피드와 OSINT 채널 목록입니다. 영상은 임베드만, 텔레그램은 일부 문장만 보여 주어 저작권을 지킵니다.",
      },
      {
        name: "CRINK 허브 모니터",
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "② 신속속보 — 역피라미드 3~4문단 줄글",
        body: "속보 양피지 본문은 육하원칙을 라벨로 나열하지 않고, 리드에 핵심을 둔 3~4문단 줄글로 씁니다. 출처·경과 시간·Tier 검증을 문장에 녹이고, 제목·요약·전장 신호만 사용합니다. 없는 사실을 지어내지 않습니다.",
      },
      {
        name: "③ 뉴스 검증 티어 (다음 책갈피)",
        body: "편집 독립과 당사자성을 기준으로 한 Tier 1·2·3 설계는 바로 다음 「⑨ 뉴스 검증 티어」 책갈피에 자세히 적혀 있습니다. 등불·속보·RSS 카드의 T1/T2/T3 뱃지와 같은 축입니다.",
      },
    ],
  },
  {
    ...
    title: "⑨ 뉴스 검증 티어",
    intro:
      "뉴스를 「얼마나 믿을지」를 점수화하지 않습니다. 대신 편집 독립과 당사자성으로 Tier 1·2·3을 나누고, 교차 확인·속보 등급에 씁니다. 지도 레이어의 관측·보도·미확인 꼬리표와는 다른 축입니다.",
    entries: [
      {
        name: "설계 원칙",
      ...
      {
        name: "Tier 1 · 기본 근거",
        body: "편집 검증을 거친 국제 통신사·대형 독립매체(예: Reuters·AP·AFP·BBC·NYT·연합 등). AI 요약·등불·신속속보의 기본 근거로 우선합니다. 정부·군 공보실 발표는 국적과 무관하게 Tier 1이 아닙니다.",
      },
      {
        name: "Tier 2 · 보완 취재",
        body: "실제 취재하되 특정 주제에서 편집 방향 논란이 반복적으로 관찰되는 매체·민간 OSINT·안보연구소. Tier 1이 얇을 때 보완하고, Tier 1 교차가 쌓이면 비중이 커집니다.",
      },
      {
        name: "Tier 3 · 당사자·국영·공보",
        body: "국영 방송·국영 통신·당·군 공보(예: TASS·신화·조선중앙통신·각국 국방부·사령부 보도자료). 「그 쪽의 말」로 읽고, 독립 매체 교차 전에는 단정하지 않습니다. 속보 대표 카드에서 Tier 3만이면 등급을 낮추거나 보류합니다.",
      },
      {
        name: "화면에 쓰는 방식",
...
export const DATA_SOURCE_FOOTNOTE = {
  ko: [
    ...
    "우리는 완벽한 정보기관이 아닙니다. 이만큼의 재료로 이만큼을 보여 주는 서비스입니다.",
  ],
  en: [
